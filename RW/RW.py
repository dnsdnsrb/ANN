...
class Network():
    def __init__(self, x_size, y_size, layers, batch_normalization=False, droprate=.0):
        self.batch_size = 128
    ...
    def info(self):
        ...
        return self.network + "-" + self.activation + "-" + layers_num + "-" + layers_sum
...
if __name__ == "__main__":
    ...
    model = Network(dataset.x_size, dataset.y_size, [175, 175, 175], batch_normalization=True)
    model.run(dataset, 100000)
