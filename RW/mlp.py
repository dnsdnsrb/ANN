...
if __name__ == "__main__":
    ...
    # model = Network(dataset.x_size, dataset.y_size, [600, 450, 300, 200, 100], batch_normalization=True)
    # model.run(dataset, 100000)
    #
    # tf.reset_default_graph()
    #
    # dataset = select_dataset('mnist')
    # model = Network(dataset.x_size, dataset.y_size, [400, 200, 100], batch_normalization=True)
    # model.run(dataset, 100000)
    #
    # tf.reset_default_graph()
    #
    ...
    model = Network(dataset.x_size, dataset.y_size, [600, 450, 300, 200, 100], droprate=0.5, batch_normalization=False)
    model.run(dataset, 100000)
